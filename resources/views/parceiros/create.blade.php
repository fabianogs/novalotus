                            ...
                            <select class="form-control @error('necessidade_id') is-invalid @enderror" 
                                ...
                                @foreach($necessidades as $necessidade)
                                    <option value="{{ $necessidade->id }}" 
                                            @if(old('necessidade_id') == $necessidade->id) selected @endif>
                                        {{ $necessidade->titulo }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="logo_carrossel">Escolher arquivo</label>
                                </div>
                            </div>
                            <small class="text-muted">Formatos aceitos: JPG, PNG, GIF, SVG. Tamanho máximo: 2MB</small>
            ...
            function previewImage(input, previewSelector) {
                if (input.files && input.files[0]) {
                    ...
                    reader.onload = function(e) {
                        $(previewSelector).html('<img src="' + e.target.result + '" alt="Preview" width="100" height="100" class="img-thumbnail">');
                    }
