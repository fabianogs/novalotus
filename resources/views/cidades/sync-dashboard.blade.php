...
@section('title', 'Dashboard de Sincronização - Cidades')

@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1>Dashboard de Sincronização - Cidades</h1>
        <div>
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <p class="text-muted">
                        Clique no botão abaixo para executar uma sincronização manual das cidades da API externa.
